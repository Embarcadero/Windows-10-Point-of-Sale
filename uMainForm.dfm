object MainForm: TMainForm
  Left = 0
  Top = 0
  Caption = 'Windows 10 Point Of Sale Template'
  ClientHeight = 686
  ClientWidth = 989
  Color = clBtnFace
  ...
  object PageControl: TPageControl
    ...
    object LoginTab: TTabSheet
      ...
      inline LoginFrame1: TLoginFrame
        ...
        inherited RelativePanel1: TRelativePanel
          ...
          ControlCollection = <
            item
              Control = LoginFrame1.VirtualImage1
        ...
        inherited RelativePanel2: TRelativePanel
          Width = 981
          Height = 402
          ControlCollection = <
            item
              Control = LoginFrame1.StackPanel1
              AlignBottomWithPanel = False
              AlignHorizontalCenterWithPanel = True
              AlignLeftWithPanel = False
              AlignRightWithPanel = False
          ...
          inherited StackPanel1: TStackPanel
            ...
            ControlCollection = <
              item
                Control = LoginFrame1.Label1
                HorizontalPositioning = sphpFill
              end
              item
                Control = LoginFrame1.UserEdit
                HorizontalPositioning = sphpFill
              end
              item
                Control = LoginFrame1.Label2
                HorizontalPositioning = sphpFill
              end
              item
                Control = LoginFrame1.PassEdit
                HorizontalPositioning = sphpFill
              end
              item
                Control = LoginFrame1.Label3
                HorizontalPositioning = sphpRight
              end
              item
                Control = LoginFrame1.Panel1
              end
              item
                Control = LoginFrame1.LoginButton
                HorizontalPositioning = sphpFill
              end>
            ExplicitLeft = 350
            ExplicitTop = 101
    ...
    object RegisterTab: TTabSheet
      Caption = 'RegisterTab'
      ImageIndex = 4
      inline RegisterFrame1: TRegisterFrame
        Left = 0
        Top = 0
        Width = 981
        Height = 619
        ...
        inherited GridPanel1: TGridPanel
          ...
          ControlCollection = <
            item
              Column = 0
              Control = RegisterFrame1.PriceModeButton
              Row = 0
            end
            item
              Column = 1
              Control = RegisterFrame1.SpeedButton12
              Row = 0
            end
            item
              Column = 2
              Control = RegisterFrame1.SpeedButton13
              Row = 0
            end
            item
              Column = 3
              Control = RegisterFrame1.SpeedButton14
              Row = 0
            end
            item
              Column = 4
              Control = RegisterFrame1.LogoutButton
              Row = 0
            end>
          ExplicitWidth = 975
          inherited PriceModeButton: TSpeedButton
            Width = 187
            ExplicitWidth = 187
          end
          ...
          inherited LogoutButton: TSpeedButton
            Left = 780
            Width = 191
            ExplicitLeft = 780
            ExplicitWidth = 191
        ...
        inherited Panel1: TPanel
          Width = 547
          ExplicitWidth = 547
          inherited ItemsStringGrid: TStringGrid
            Width = 539
            ExplicitWidth = 539
          end
        ...
        inherited Panel3: TPanel
          ...
          inherited GridPanel2: TGridPanel
            ControlCollection = <
              item
                Column = 0
                Control = RegisterFrame1.Num1Button
                Row = 0
              end
              item
                Column = 1
                Control = RegisterFrame1.Num2Button
                Row = 0
              end
              item
                Column = 2
                Control = RegisterFrame1.Num3Button
                Row = 0
              end
              item
                Column = 0
                Control = RegisterFrame1.Num4Button
                Row = 1
              end
              item
                Column = 1
                Control = RegisterFrame1.Num5Button
                Row = 1
              end
              item
                Column = 2
                Control = RegisterFrame1.Num6Button
                Row = 1
              end
              item
                Column = 0
                Control = RegisterFrame1.Num7Button
                Row = 2
              end
              item
                Column = 1
                Control = RegisterFrame1.Num8Button
                Row = 2
              end
              item
                Column = 2
                Control = RegisterFrame1.Num9Button
                Row = 2
              end
              item
                Column = 0
                Control = RegisterFrame1.ClearButton
                Row = 3
              end
              item
                Column = 1
                Control = RegisterFrame1.Num0Button
                Row = 3
              end
              item
                Column = 2
                Control = RegisterFrame1.BackButton
                Row = 3
              end>
          end
        end
    ...
    object ProductsTab: TTabSheet
      Caption = 'ProductsTab'
      ImageIndex = 2
      inline ProductsFrame1: TProductsFrame
        Left = 0
        Top = 0
        Width = 981
        Height = 619
        ...
        ExplicitWidth = 981
        ExplicitHeight = 619
        inherited BindNavigator5: TBindNavigator
          Top = 594
          Width = 931
          Hints.Strings = ()
          ExplicitTop = 594
        ...
        inherited Panel8: TPanel
          ...
          inherited ProductsRelativePanel: TRelativePanel
            ...
            ControlCollection = <
              item
                Control = ProductsFrame1.SearchBox
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = True
              ...
              item
                Control = ProductsFrame1.DeleteButton
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = False
                AlignTopWithPanel = False
                AlignVerticalCenterWithPanel = True
                LeftOf = ProductsFrame1.SearchBox
              end
              item
                Control = ProductsFrame1.EditButton
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = False
                AlignTopWithPanel = False
                AlignVerticalCenterWithPanel = True
                LeftOf = ProductsFrame1.DeleteButton
              end
              item
                Control = ProductsFrame1.AddButton
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = False
                AlignTopWithPanel = False
                AlignVerticalCenterWithPanel = True
                LeftOf = ProductsFrame1.EditButton
              end>
            ExplicitWidth = 709
        ...
        inherited AllStringGrid: TStringGrid
          Width = 931
          Height = 488
          ExplicitWidth = 931
          ExplicitHeight = 488
    ...
    object ReportsTab: TTabSheet
      Caption = 'ReportsTab'
      ImageIndex = 3
      inline ReportsFrame1: TReportsFrame
        Left = 0
        Top = 0
        Width = 981
        Height = 619
        ...
        ExplicitWidth = 981
        ExplicitHeight = 619
        inherited ReportsSG: TStringGrid
          Top = 129
          Width = 931
          Height = 456
          ExplicitTop = 129
        ...
        inherited Panel8: TPanel
          ...
          inherited UsersRelativePanel: TRelativePanel
            ...
            ControlCollection = <
              item
                Control = ReportsFrame1.SearchBox
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = True
              ...
              item
                Control = ReportsFrame1.DeleteButton
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = False
                AlignTopWithPanel = False
                AlignVerticalCenterWithPanel = True
                LeftOf = ReportsFrame1.SearchBox
              end
              item
                Control = ReportsFrame1.ViewButton
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = False
                AlignTopWithPanel = False
                AlignVerticalCenterWithPanel = True
                LeftOf = ReportsFrame1.DeleteButton
              end>
            ExplicitWidth = 725
            inherited SearchBox: TSearchBox
              Left = 539
            ...
            inherited ViewButton: TSpeedButton
              Left = 294
              ExplicitLeft = 294
            end
          end
    ...
    object UsersTab: TTabSheet
      Caption = 'UsersTab'
      ImageIndex = 1
      inline UsersFrame1: TUsersFrame
        Left = 0
        Top = 0
        Width = 981
        Height = 619
        ...
        inherited Panel8: TPanel
          ...
          inherited UsersRelativePanel: TRelativePanel
            ...
            ControlCollection = <
              ...
              item
                Control = UsersFrame1.CreateUserButton
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = False
                AlignTopWithPanel = False
                AlignVerticalCenterWithPanel = True
                LeftOf = UsersFrame1.RemoveUserButton
              end
              item
                Control = UsersFrame1.RemoveUserButton
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = False
                AlignTopWithPanel = False
                AlignVerticalCenterWithPanel = True
                LeftOf = UsersFrame1.SearchBox
              end
              item
                Control = UsersFrame1.ResetButton
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = False
                AlignTopWithPanel = False
                AlignVerticalCenterWithPanel = True
                LeftOf = UsersFrame1.CreateUserButton
              end>
            ExplicitWidth = 761
            inherited SearchBox: TSearchBox
              Left = 575
            ...
            inherited CreateUserButton: TSpeedButton
              Left = 330
              ExplicitLeft = 330
            end
            inherited RemoveUserButton: TSpeedButton
              Left = 451
              ExplicitLeft = 451
            end
            inherited ResetButton: TSpeedButton
              Left = 209
              ExplicitLeft = 209
            end
          end
        end
        inherited UsersSG: TStringGrid
          Width = 931
          Height = 509
          ExplicitWidth = 931
          ExplicitHeight = 509
    ...
    object UpdateProductTab: TTabSheet
      Caption = 'UpdateProductTab'
      ImageIndex = 5
      inline UpdateProductFrame1: TUpdateProductFrame
        Left = 0
        Top = 0
        Width = 981
        Height = 619
        ...
        inherited Panel8: TPanel
          ...
          inherited UpdateRelativePanel: TRelativePanel
            ...
            ControlCollection = <
              item
                Control = UpdateProductFrame1.CancelButton
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = True
              ...
              item
                Control = UpdateProductFrame1.SaveButton
                AlignBottomWithPanel = False
                AlignHorizontalCenterWithPanel = False
                AlignLeftWithPanel = False
                AlignRightWithPanel = False
                AlignTopWithPanel = False
                AlignVerticalCenterWithPanel = True
                LeftOf = UpdateProductFrame1.CancelButton
              end>
            ExplicitWidth = 605
        ...
        inherited ScrollBox1: TScrollBox
          ...
          inherited Panel5: TPanel
            Width = 663
            ExplicitWidth = 663
            inherited CategoryCB: TComboBox
              Width = 552
              ExplicitWidth = 552
            end
          end
  ...
  object HeaderPanel: TPanel
    ...
    object FullScreenVirtualImage: TVirtualImage
      AlignWithMargins = True
      Left = 949
      Top = 3
      Width = 32
      ...
      OnClick = FullScreenVirtualImageClick
      ExplicitLeft = 953
      ExplicitTop = -4
    end
    object VCLFrameThemeCB: TComboBox
      AlignWithMargins = True
      Left = 647
      Top = 10
      Width = 145
      ...
      TabOrder = 0
      TabStop = False
      TextHint = 'Select Frame Theme'
      StyleName = 'Windows10 SlateGray'
      OnChange = VCLFrameThemeCBChange
      OnKeyPress = VCLFrameThemeCBKeyPress
    end
    object VCLBodyThemeCB: TComboBox
      AlignWithMargins = True
      Left = 798
      Top = 10
      Width = 145
      ...
      TabOrder = 1
      TabStop = False
      TextHint = 'Select Body Theme'
      StyleName = 'Windows10 SlateGray'
      OnChange = VCLBodyThemeCBChange
      OnKeyPress = VCLFrameThemeCBKeyPress
    end
  end
  object SplitView: TSplitView
    ...
    object NavPanel: TPanel
      ...
      object ProductsButton: TButton
        ...
        TabOrder = 2
        StyleName = 'Windows10 SlateGray'
        OnClick = ProductsButtonClick
      end
      object ReportsButton: TButton
        Tag = 5
        Left = 0
        Top = 114
        Width = 0
